...
//	public String getBoardList(Model model, Board board) {
	...
	public String insertBoard(Board board,RedirectAttributes rttr,@AuthenticationPrincipal SecurityUser principal) {
	...
	public String deleteBoard(Board board,RedirectAttributes rttr) {
		rttr.addFlashAttribute("success","success");
